...
import { Cart, ProductList } from "./component";
  ...
  return (
    <div className="container">
      ...
      <Modal open={isModalOpen} footer={false} closeIcon={false}>
        <div>
          <IoIosCheckmarkCircleOutline size={28} color="green" />
          ...
          <button className="bg-red-700 w-full mt-5 py-[15px] rounded-[20px] cursor-pointer bg-red text-rose-100 border-none text-lg" onClick={resetCart}>Start New Order</button>
        </div>
      </Modal>
    </div>
  );
