...
const DoctorCard = ({ currentDoctors }: DoctorGridProps) => {
  ...
  const settings = {
    ...
    slidesToShow: Math.min(
      currentDoctors
        ...
        : 0,
      3
    ), // عدد العناصر بناءً على ما هو متاح
  ...
  return (
    <div className="h-full  mt-[5px]  font-serif">
              ...
              <div className="shadow-2xl  bg-white rounded-xl  border-solid   ">
                <div className="flex flex-row max-md:flex-col justify-center items-center max-xl:gap-3 p-4 max-xl:items-center gap-5 w-full h-auto">
                  ...
                  <div className="flex-1 max-md:flex max-md:flex-col max-md:items-center">
                    <h1 className="text-[#222F66] font-bold max-sm:max-h-[21px]  w-full overflow-hidden">
                      د/ {doctor?.doctorName}
                    </h1>
                    <h4 className="text-xl ">{doctor?.specialist}</h4>
                    <h4 className="opacity-50 overflow-hidden max-h-16 min-h-5 text-wrap">
                      {doctor?.information}
                    </h4>
                  </div>
                </div>
