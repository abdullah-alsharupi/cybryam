...
colors.reverse()
  ...
  return (
    <div className="h-[100%] w-[100%] flex flex-col justify-between">
      ...
      <h1 className="font-bold text-red-600 py-1 px-2 max-sm:text-[15px]">العدد الكلي للدكاترة: {totalCount}</h1>
      <div className="h-[300px] w-[100%]">
        <ResponsiveContainer width="100%" className={`sm:hidden text-[12px]`} height="100%">
