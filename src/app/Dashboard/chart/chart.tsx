...
const Chart = (props:PropsCharDepartment) => {
  ...
  return (
    <div className="h-[100%] w-[100%] flex flex-col justify-between">
      <h1 className="text-center text-green-800 text-[20px] max-sm:text-[15px] font-bold py-2">
        إحصائيات عدد الامراض لكل قسم
      </h1>
      
      <h1 className="font-bold text-red-600 py-1 max-sm:text-[15px] px-2">العدد الكلي للأمراض: {totalCount}</h1>
      <div className="h-[300px] w-[100%]">
        <ResponsiveContainer className={`max-sm:hidden `} width="100%" height="100%">
          <PieChart width={300} height={300}>
            ...
            <Legend
            className="font-bold pr-1 font-serif"
              //@ts-ignore
        ...
        <ResponsiveContainer className={`sm:hidden text-[12px]`} width="100%" height="100%">
          <PieChart width={300} height={300}>
            <Pie
              className=""
              data={data}
              ...
              cx="50%"
              cy="50%"
              outerRadius={50} // نصف قطر الخارجي
              innerRadius={30}
