...
const Login: React.FC = () => {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    if (result?.ok) {
      ...
      toast.error("خطأ في عملية الدخول ");
    }
  };

  return (
    <div className="flex items-center justify-center h-screen bg-slate-900 font-serif" dir="rtl">
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        <h2 className="text-2xl font-bold mb-4 items-center">تسجيل الدخول</h2>
